...
cData = pd.read_csv("C:\\Users\\HP\\OneDrive\\Desktop\\Ynit\\White-Hats\\Analytics\\001.csv")
fData = pd.read_csv("C:\\Users\\HP\\OneDrive\\Desktop\\Ynit\\White-Hats\\Analytics\\002.csv")

st.title("Risk Prone Areas - with Volunteer locactions")
